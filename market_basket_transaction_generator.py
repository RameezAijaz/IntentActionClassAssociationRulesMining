...
all_transactions_file_stream = open(all_transactions_file, "w")
all_no_intent_file = output_directory + '/no_transactions/all_no_intent.txt'
all_no_intent_file_stream = open(all_no_intent_file, "w")
all_error_file = output_directory + '/errors/all_error.txt'
all_error_file_stream = open(all_error_file, "w")


transaction_r_format_file = output_directory + '/transaction_r_format_file.txt'
transaction_r_format_file_stream = open(transaction_r_format_file, "w")
...
all_transactions_file_stream.close();
